CREATE OR REPLACE VIEW "biological_occurrence_view" AS SELECT
  ...
  "associatedMedia",
  "occurrenceID",
  "associatedOccurrences".value AS "associatedOccurrences",
  ...
  LEFT JOIN "associatedOccurrences" ON "associatedOccurrences"."biological_occurrence_id" = bo."occurrenceID"
...
BEGIN
	WITH "inserted_continent_id" AS (
		INSERT INTO "continent" (value) VALUES (new_ref."continent") ON CONFLICT DO NOTHING RETURNING id
	), "continent_id" AS (
		...
		INSERT INTO "country" ("countryCode", value, "continent_id") (SELECT new_ref."countryCode", new_ref."country", id FROM "continent_id") ON CONFLICT DO NOTHING RETURNING "countryCode"
		...
		INSERT INTO "stateProvince" (value, "country_id") (SELECT new_ref."stateProvince", "countryCode" FROM "country_countryCode") ON CONFLICT DO NOTHING RETURNING id
	), "stateProvince_id" AS (
		...
		INSERT INTO "county" (value, "stateProvince_id") (SELECT new_ref."county", id FROM "stateProvince_id") ON CONFLICT DO NOTHING RETURNING id
	), "county_id" AS (
		...
		INSERT INTO "municipality" (value, "county_id") (SELECT new_ref."municipality", id FROM "county_id") ON CONFLICT DO NOTHING RETURNING id
	), "municipality_id" AS (
		...
		INSERT INTO "geodeticDatum" (value) (SELECT new_ref."geodeticDatum") ON CONFLICT DO NOTHING RETURNING id
	), "geodeticDatum_id" AS (
		...
		INSERT INTO "verbatimLocality" (value) (SELECT new_ref."verbatimLocality") ON CONFLICT DO NOTHING RETURNING id
		...
		INSERT INTO "kingdom" (value) VALUES (new_ref."kingdom") ON CONFLICT DO NOTHING RETURNING id
	), "kingdom_id" AS (
		...
		INSERT INTO "phylum" (value, "kingdom_id") (SELECT new_ref."phylum", id FROM "kingdom_id") ON CONFLICT DO NOTHING RETURNING id
	), "phylum_id" AS (
		...
		INSERT INTO "class" (value, "phylum_id") (SELECT new_ref."class", id FROM "phylum_id") ON CONFLICT DO NOTHING RETURNING id
	), "class_id" AS (
		...
		INSERT INTO "order" (value, "class_id") (SELECT new_ref."order", id FROM "class_id") ON CONFLICT DO NOTHING RETURNING id
	), "order_id" AS (
		...
		INSERT INTO "family" (value, "order_id") (SELECT new_ref."family", id FROM "order_id") ON CONFLICT DO NOTHING RETURNING id
	), "family_id" AS (
		...
		INSERT INTO "genus" (value, "family_id") (SELECT new_ref."genus", id FROM "family_id") ON CONFLICT DO NOTHING RETURNING id
	), "genus_id" AS (
		...
		INSERT INTO "subgenus" (value, "genus_id") (SELECT new_ref."subgenus", id FROM "genus_id") ON CONFLICT DO NOTHING RETURNING id
	), "subgenus_id" AS (
		...
		INSERT INTO "artificial:subfamily" (value, "family_id") (SELECT new_ref."artificial:subfamily", id FROM "family_id") ON CONFLICT DO NOTHING RETURNING id
		...
		INSERT INTO "taxonomicStatus" (value) (SELECT new_ref."taxonomicStatus") ON CONFLICT DO NOTHING RETURNING id
		...
		INSERT INTO "nomenclaturalCode" (value) (SELECT new_ref."nomenclaturalCode") ON CONFLICT DO NOTHING RETURNING id
		...
		INSERT INTO "nameAccordingTo" (value) (SELECT new_ref."nameAccordingTo") ON CONFLICT DO NOTHING RETURNING id
		...
		INSERT INTO "recordedBy" (value) (SELECT unnest(string_to_array(new_ref."recordedBy", ';')) AS value) ON CONFLICT DO NOTHING RETURNING id
	), "recordedBy_id" AS (
		...
		INSERT INTO "identifiedBy" (value) (SELECT unnest(string_to_array(new_ref."recordedBy", ';')) AS value) ON CONFLICT DO NOTHING RETURNING id
	), "identifiedBy_id" AS (
		...
		INSERT INTO "datasetName" (value) (SELECT new_ref."datasetName") ON CONFLICT DO NOTHING RETURNING id
	), "datasetName_id" AS (
		...
		INSERT INTO "artificial:shelfLocation" (value) (SELECT new_ref."artificial:shelfLocation") ON CONFLICT DO NOTHING RETURNING id
		...
		INSERT INTO "artificial:flaskLocation" (value) (SELECT new_ref."artificial:flaskLocation") ON CONFLICT DO NOTHING RETURNING id
		...
		INSERT INTO "sex" (value) (SELECT new_ref."sex") ON CONFLICT DO NOTHING RETURNING id
	), "sex_id" AS (
		...
		INSERT INTO "reproductiveCondition" (value) (SELECT new_ref."reproductiveCondition") ON CONFLICT DO NOTHING RETURNING id
		...
		INSERT INTO "disposition" (value) (SELECT new_ref."disposition") ON CONFLICT DO NOTHING RETURNING id
	), "disposition_id" AS (
		...
		INSERT INTO "habitat" (value) (SELECT new_ref."habitat") ON CONFLICT DO NOTHING RETURNING id
	), "habitat_id" AS (
		...
		INSERT INTO "waterBody" (value) (SELECT new_ref."waterBody") ON CONFLICT DO NOTHING RETURNING id
	), "waterBody_id" AS (
		...
		INSERT INTO "identificationQualifier" (value) (SELECT new_ref."identificationQualifier") ON CONFLICT DO NOTHING RETURNING id
		...
		INSERT INTO "artificial:section" (value) (SELECT new_ref."artificial:section") ON CONFLICT DO NOTHING RETURNING id
		...
		INSERT INTO "basisOfRecord" (value) (SELECT new_ref."basisOfRecord") ON CONFLICT DO NOTHING RETURNING id
	), "basisOfRecord_id" AS (
		...
		INSERT INTO "institutionCode" (value) (SELECT new_ref."institutionCode") ON CONFLICT DO NOTHING RETURNING id
		...
		INSERT INTO "collectionCode" (value) (SELECT new_ref."collectionCode") ON CONFLICT DO NOTHING RETURNING id
		...
		INSERT INTO "preparations" (value) (SELECT new_ref."preparations") ON CONFLICT DO NOTHING RETURNING id
	), "preparations_id" AS (
		...
		INSERT INTO "lifeStage" (value) (SELECT new_ref."lifeStage") ON CONFLICT DO NOTHING RETURNING id
	), "lifeStage_id" AS (
		...
		INSERT INTO "establishmentMeans" (value) (SELECT new_ref."establishmentMeans") ON CONFLICT DO NOTHING RETURNING id
		...
		INSERT INTO "behavior" (value) (SELECT new_ref."behavior") ON CONFLICT DO NOTHING RETURNING id
	), "behavior_id" AS (
		...
		INSERT INTO "specie" ("typeStatus", "scientificName", "scientificNameAuthorship", "acceptedNameUsage", "subgenus_id", "artificial:subfamily_id", "specificEpithet", "infraspecificEpithet", "taxonRank", "taxonomicStatus_id", "originalNameUsage", "vernacularName", "nomenclaturalCode_id", "nameAccordingTo_id") (SELECT new_ref."typeStatus", new_ref."scientificName", new_ref."scientificNameAuthorship", new_ref."acceptedNameUsage", "subgenus_id".id AS "subgenus_id", "artificial:subfamily_id".id AS "artificial:subfamily_id" , new_ref."specificEpithet", new_ref."infraspecificEpithet", new_ref."taxonRank", "taxonomicStatus_id".id AS "taxonomicStatus_id", new_ref."originalNameUsage", new_ref."vernacularName", "nomenclaturalCode_id".id AS "nomenclaturalCode_id", "nameAccordingTo_id".id AS "nameAccordingTo_id" FROM "subgenus_id", "artificial:subfamily_id", "taxonomicStatus_id", "nomenclaturalCode_id", "nameAccordingTo_id") ON CONFLICT DO NOTHING RETURNING id
	), "specie_id" AS (
