CREATE
OR REPLACE VIEW "biological_occurrence_view" AS
SELECT "artificial:section".value       AS "artificial:section",
       "dcterms:modified",
       "informationWithheld",
...
FROM biological_occurrence AS bo
         ...
         LEFT JOIN "recordedBy_biological_occurrence"
                   ON "recordedBy_biological_occurrence".biological_occurrence_id = bo."occurrenceID"
         ...
         LEFT JOIN "identifiedBy_biological_occurrence"
                   ON "identifiedBy_biological_occurrence"."biological_occurrence_id" = bo."occurrenceID"
...
CREATE
OR REPLACE FUNCTION func_setof_biological_occurrence (new_ref anyelement) RETURNS setof biological_occurrence AS $$
BEGIN
WITH "inserted_continent_id" AS (
INSERT
INTO "continent" (value) (SELECT new_ref."continent" WHERE new_ref."continent" IS NOT NULL)
...
INSERT
INTO "country" ("countryCode", value, "continent_id") (SELECT new_ref."countryCode", new_ref."country", id FROM
                                                       "continent_id" WHERE new_ref."countryCode" IS NOT NULL AND
                                                       new_ref."country" IS NOT NULL AND id IS NOT NULL)
ON CONFLICT DO NOTHING RETURNING "countryCode"
...
INSERT
INTO "stateProvince" (value, "country_id") (SELECT new_ref."stateProvince", "countryCode" FROM "country_countryCode"
                                            WHERE new_ref."stateProvince" IS NOT NULL AND "countryCode" IS NOT NULL)
ON CONFLICT DO NOTHING RETURNING id
    ), "stateProvince_id" AS (
...
INSERT
INTO "county" (value, "stateProvince_id") (SELECT new_ref."county", id FROM "stateProvince_id" WHERE new_ref."county" IS
...
INSERT
INTO "municipality" (value, "county_id") (SELECT new_ref."municipality", id FROM "county_id" WHERE new_ref.
                                          "municipality" IS NOT NULL AND id IS NOT NULL)
ON CONFLICT DO NOTHING RETURNING id
    ), "municipality_id" AS (
...
INSERT
INTO "geodeticDatum" (value) (SELECT new_ref."geodeticDatum" WHERE new_ref."geodeticDatum" IS NOT NULL)
ON CONFLICT DO NOTHING RETURNING id
    ), "geodeticDatum_id" AS (
...
INSERT
INTO "verbatimLocality" (value) (SELECT new_ref."verbatimLocality" WHERE new_ref."verbatimLocality" IS NOT NULL)
ON CONFLICT DO NOTHING RETURNING id
...
INSERT
INTO "kingdom" (value) (SELECT new_ref."kingdom" WHERE new_ref."kingdom" IS NOT NULL)
ON CONFLICT DO NOTHING RETURNING id
    ), "kingdom_id" AS (
...
INSERT
INTO "phylum" (value, "kingdom_id") (SELECT new_ref."phylum", id FROM "kingdom_id" WHERE new_ref."phylum" IS NOT NULL
                                     AND id IS NOT NULL)
ON CONFLICT DO NOTHING RETURNING id
    ), "phylum_id" AS (
...
INSERT
INTO "class" (value, "phylum_id") (SELECT new_ref."class", id FROM "phylum_id" WHERE new_ref."class" IS NOT NULL AND id
                                   IS NOT NULL)
ON CONFLICT DO NOTHING RETURNING id
    ), "class_id" AS (
...
INSERT
INTO "order" (value, "class_id") (SELECT new_ref."order", id FROM "class_id" WHERE new_ref."order" IS NOT NULL AND id IS
                                  NOT NULL)
ON CONFLICT DO NOTHING RETURNING id
    ), "order_id" AS (
...
INSERT
INTO "family" (value, "order_id") (SELECT new_ref."family", id FROM "order_id" WHERE new_ref."family" IS NOT NULL AND id
                                   IS NOT NULL)
ON CONFLICT DO NOTHING RETURNING id
    ), "family_id" AS (
...
INSERT
INTO "genus" (value, "family_id") (SELECT new_ref."genus", id FROM "family_id" WHERE new_ref."genus" IS NOT NULL AND id
                                   IS NOT NULL)
ON CONFLICT DO NOTHING RETURNING id
    ), "genus_id" AS (
...
INSERT
INTO "subGenus" (value, "genus_id") (SELECT new_ref."subGenus", id FROM "genus_id" WHERE new_ref."subGenus" IS NOT NULL
                                     AND id IS NOT NULL)
ON CONFLICT DO NOTHING RETURNING id
    ), "subGenus_id" AS (
...
INSERT
INTO "artificial:subFamily" (value, "family_id") (SELECT new_ref."artificial:subFamily", id FROM "family_id" WHERE
                                                  new_ref."artificial:subFamily" IS NOT NULL AND id IS NOT NULL)
ON CONFLICT DO NOTHING RETURNING id
...
INSERT
INTO "artificial:tribe" (value, "family_id") (SELECT new_ref."artificial:tribe", id FROM "family_id" WHERE new_ref.
                                              "artificial:tribe" IS NOT NULL AND id IS NOT NULL)
ON CONFLICT DO NOTHING RETURNING id
...
INSERT
INTO "artificial:subTribe" (value, "tribe_id") (SELECT new_ref."artificial:subTribe", id FROM "artificial:tribe_id"
                                                WHERE new_ref."artificial:subTribe" IS NOT NULL AND id IS NOT NULL)
ON CONFLICT DO NOTHING RETURNING id
...
INSERT
INTO "artificial:superFamily" (value, "order_id") (SELECT new_ref."artificial:superFamily", id FROM "order_id" WHERE
                                                   new_ref."artificial:superFamily" IS NOT NULL AND id IS NOT NULL)
ON CONFLICT DO NOTHING RETURNING id
...
INSERT
INTO "artificial:infraOrder" (value, "order_id") (SELECT new_ref."artificial:infraOrder", id FROM "order_id" WHERE
                                                  new_ref."artificial:infraOrder" IS NOT NULL AND id IS NOT NULL)
ON CONFLICT DO NOTHING RETURNING id
...
INSERT
INTO "artificial:subOrder" (value, "order_id") (SELECT new_ref."artificial:subOrder", id FROM "order_id" WHERE new_ref.
                                                "artificial:subOrder" IS NOT NULL AND id IS NOT NULL)
ON CONFLICT DO NOTHING RETURNING id
...
INSERT
INTO "artificial:superOrder" (value, "class_id") (SELECT new_ref."artificial:superOrder", id FROM "class_id" WHERE
                                                  new_ref."artificial:superOrder" IS NOT NULL AND id IS NOT NULL)
ON CONFLICT DO NOTHING RETURNING id
...
INSERT
INTO "artificial:subClass" (value, "class_id") (SELECT new_ref."artificial:subClass", id FROM "class_id" WHERE new_ref.
                                                "artificial:subClass" IS NOT NULL AND id IS NOT NULL)
ON CONFLICT DO NOTHING RETURNING id
...
INSERT
INTO "artificial:subPhylum" (value, "phylum_id") (SELECT new_ref."artificial:subPhylum", id FROM "phylum_id" WHERE
                                                  new_ref."artificial:subPhylum" IS NOT NULL AND id IS NOT NULL)
ON CONFLICT DO NOTHING RETURNING id
...
INSERT
INTO "taxonomicStatus" (value) (SELECT new_ref."taxonomicStatus" WHERE new_ref."taxonomicStatus" IS NOT NULL)
ON CONFLICT DO NOTHING RETURNING id
...
INSERT
INTO "nomenclaturalCode" (value) (SELECT new_ref."nomenclaturalCode" WHERE new_ref."nomenclaturalCode" IS NOT NULL)
ON CONFLICT DO NOTHING RETURNING id
...
INSERT
INTO "nameAccordingTo" (value) (SELECT new_ref."nameAccordingTo" WHERE new_ref."nameAccordingTo" IS NOT NULL)
ON CONFLICT DO NOTHING RETURNING id
...
INSERT
INTO "recordedBy" (value) (SELECT unnest(string_to_array(new_ref."recordedBy", ';')) AS value WHERE new_ref."recordedBy" IS NOT NULL)
ON CONFLICT DO NOTHING RETURNING id
    ), "recordedBy_id" AS (
...
INSERT
INTO "identifiedBy" (value) (SELECT unnest(string_to_array(new_ref."recordedBy", ';')) AS value WHERE new_ref."recordedBy" IS NOT NULL)
ON CONFLICT DO NOTHING RETURNING id
    ), "identifiedBy_id" AS (
...
INSERT
INTO "datasetName" (value) (SELECT new_ref."datasetName" WHERE new_ref."datasetName" IS NOT NULL)
ON CONFLICT DO NOTHING RETURNING id
    ), "datasetName_id" AS (
...
INSERT
INTO "artificial:shelfLocation" (value) (SELECT new_ref."artificial:shelfLocation" WHERE new_ref."artificial:shelfLocation" IS NOT NULL)
ON CONFLICT DO NOTHING RETURNING id
...
INSERT
INTO "artificial:flaskLocation" (value) (SELECT new_ref."artificial:flaskLocation" WHERE new_ref."artificial:flaskLocation" IS NOT NULL)
ON CONFLICT DO NOTHING RETURNING id
...
INSERT
INTO "sex" (value) (SELECT new_ref."sex" WHERE new_ref."sex" IS NOT NULL)
ON CONFLICT DO NOTHING RETURNING id
    ), "sex_id" AS (
...
INSERT
INTO "reproductiveCondition" (value) (SELECT new_ref."reproductiveCondition" WHERE new_ref."reproductiveCondition" IS NOT NULL)
ON CONFLICT DO NOTHING RETURNING id
...
INSERT
INTO "disposition" (value) (SELECT new_ref."disposition" WHERE new_ref."disposition" IS NOT NULL)
ON CONFLICT DO NOTHING RETURNING id
    ), "disposition_id" AS (
...
INSERT
INTO "habitat" (value) (SELECT new_ref."habitat" WHERE new_ref."habitat" IS NOT NULL)
ON CONFLICT DO NOTHING RETURNING id
    ), "habitat_id" AS (
...
INSERT
INTO "waterBody" (value) (SELECT new_ref."waterBody" WHERE new_ref."waterBody" IS NOT NULL)
ON CONFLICT DO NOTHING RETURNING id
    ), "waterBody_id" AS (
...
INSERT
INTO "identificationQualifier" (value) (SELECT new_ref."identificationQualifier" WHERE new_ref."identificationQualifier" IS NOT NULL)
ON CONFLICT DO NOTHING RETURNING id
...
INSERT
INTO "artificial:section" (value) (SELECT new_ref."artificial:section" WHERE new_ref."artificial:section" IS NOT NULL)
ON CONFLICT DO NOTHING RETURNING id
...
INSERT
INTO "basisOfRecord" (value) (SELECT new_ref."basisOfRecord" WHERE new_ref."basisOfRecord" IS NOT NULL)
ON CONFLICT DO NOTHING RETURNING id
    ), "basisOfRecord_id" AS (
...
INSERT
INTO "institutionCode" (value) (SELECT new_ref."institutionCode" WHERE new_ref."institutionCode" IS NOT NULL)
ON CONFLICT DO NOTHING RETURNING id
...
INSERT
INTO "collectionCode" (value) (SELECT new_ref."collectionCode" WHERE new_ref."collectionCode" IS NOT NULL)
ON CONFLICT DO NOTHING RETURNING id
...
INSERT
INTO "preparations" (value) (SELECT new_ref."preparations" WHERE new_ref."preparations" IS NOT NULL)
ON CONFLICT DO NOTHING RETURNING id
    ), "preparations_id" AS (
...
INSERT
INTO "lifeStage" (value) (SELECT new_ref."lifeStage" WHERE new_ref."lifeStage" IS NOT NULL)
ON CONFLICT DO NOTHING RETURNING id
    ), "lifeStage_id" AS (
...
INSERT
INTO "establishmentMeans" (value) (SELECT new_ref."establishmentMeans" WHERE new_ref."establishmentMeans" IS NOT NULL)
ON CONFLICT DO NOTHING RETURNING id
...
INSERT
INTO "behavior" (value) (SELECT new_ref."behavior" WHERE new_ref."behavior" IS NOT NULL)
ON CONFLICT DO NOTHING RETURNING id
    ), "behavior_id" AS (
...
INSERT
INTO "specie" ("typeStatus", "scientificName", "scientificNameAuthorship", "acceptedNameUsage", "subGenus_id",
               "artificial:subFamily_id", "artificial:subTribe_id", "artificial:tribe_id", "artificial:superFamily_id",
               "artificial:infraOrder_id", "artificial:subOrder_id", "artificial:superOrder_id",
               "artificial:subClass_id", "artificial:subPhylum_id", "specificEpithet", "infraspecificEpithet",
               "taxonRank", "taxonomicStatus_id", "originalNameUsage", "vernacularName", "nomenclaturalCode_id",
               "nameAccordingTo_id") (SELECT new_ref."typeStatus", new_ref."scientificName", new_ref.
                                      "scientificNameAuthorship", new_ref."acceptedNameUsage", "subGenus_id".id AS
                                      "subGenus_id", "artificial:subFamily_id".id AS "artificial:subFamily_id",
                                      "artificial:subTribe_id".id AS "artificial:subTribe_id", "artificial:tribe_id".
                                      id AS "artificial:tribe_id", "artificial:superFamily_id".id AS
                                      "artificial:superFamily_id", "artificial:infraOrder_id".id AS
                                      "artificial:infraOrder_id", "artificial:subOrder_id".id AS
                                      "artificial:subOrder_id", "artificial:superOrder_id".id AS
                                      "artificial:superOrder_id", "artificial:subClass_id".id AS
                                      "artificial:subClass_id", "artificial:subPhylum_id".id AS
                                      "artificial:subPhylum_id", new_ref."specificEpithet", new_ref.
                                      "infraspecificEpithet", new_ref."taxonRank", "taxonomicStatus_id".id AS
                                      "taxonomicStatus_id", new_ref."originalNameUsage", new_ref."vernacularName",
                                      "nomenclaturalCode_id".id AS "nomenclaturalCode_id", "nameAccordingTo_id".id AS
                                      "nameAccordingTo_id" FROM "subGenus_id", "artificial:subFamily_id",
                                      "artificial:subTribe_id", "artificial:tribe_id", "artificial:superFamily_id",
                                      "artificial:infraOrder_id", "artificial:subOrder_id", "artificial:superOrder_id",
                                      "artificial:subClass_id", "artificial:subPhylum_id", "taxonomicStatus_id",
                                      "nomenclaturalCode_id", "nameAccordingTo_id")
ON CONFLICT DO NOTHING RETURNING id
    ), "specie_id" AS (
...
INSERT
INTO "locality" ("value", "decimalLatitude", "decimalLongitude", "verbatimLatitude", "verbatimLongitude",
                 "coordinatePrecision", "geodeticDatum_id", "footprintWKT", "minimumElevationInMeters",
                 "maximumElevationInMeters", "municipality_id", "verbatimLocality_id") (SELECT new_ref."locality" AS
                                                                                        value, new_ref.
                                                                                        "decimalLatitude", new_ref.
                                                                                        "decimalLongitude", new_ref.
                                                                                        "verbatimLatitude", new_ref.
                                                                                        "verbatimLongitude", new_ref.
                                                                                        "coordinatePrecision",
                                                                                        "geodeticDatum_id".id AS
                                                                                        "geodeticDatum_id", new_ref.
                                                                                        "footprintWKT", new_ref.
                                                                                        "minimumElevationInMeters",
                                                                                        new_ref.
                                                                                        "maximumElevationInMeters",
                                                                                        "municipality_id".id AS
                                                                                        "municipality_id",
                                                                                        "verbatimLocality_id".id AS
                                                                                        "verbatimLocality_id" FROM
                                                                                        "geodeticDatum_id",
                                                                                        "municipality_id",
                                                                                        "verbatimLocality_id")
ON CONFLICT DO NOTHING RETURNING id
...
INSERT
INTO "biological_occurrence" ("occurrenceID", "artificial:section_id", "dcterms:modified", "informationWithheld",
                              "basisOfRecord_id", "institutionCode_id", "collectionCode_id",
                              "dcterms:bibliographicCitation", "datasetName_id", "artificial:shelfLocation_id",
                              "artificial:flaskLocation_id", "artificial:shippingGuide", "catalogNumber",
                              "otherCatalogNumbers", "preparations_id", "individualCount", "sex_id", "lifeStage_id",
                              "reproductiveCondition_id", "establishmentMeans_id", "behavior_id", "occurrenceRemarks",
                              "disposition_id", "associatedReferences", "associatedMedia", "previousIdentifications",
                              "associatedOccurrences", "fieldNumber", "day", "month", "year", "eventTime", "eventDate",
                              "verbatimEventDate", "samplingProtocol", "habitat_id", "eventRemarks", "fieldNotes",
                              "measurementRemarks", "specie_id", "locality_id", "waterBody_id", "minimumDepthInMeters",
                              "maximumDepthInMeters", "locationRemarks", "identificationQualifier_id",
                              "relationshipOfResource") (SELECT new_ref."occurrenceID", "artificial:section_id".id AS
                                                         "artificial:section_id", new_ref."dcterms:modified", new_ref.
                                                         "informationWithheld", "basisOfRecord_id".id AS
                                                         "basisOfRecord_id", "institutionCode_id".id AS
                                                         "institutionCode_id", "collectionCode_id".id AS
                                                         "collectionCode_id", new_ref."dcterms:bibliographicCitation",
                                                         "datasetName_id".id AS "datasetName_id",
                                                         "artificial:shelfLocation_id".id AS
                                                         "artificial:shelfLocation_id", "artificial:flaskLocation_id".
                                                         id AS "artificial:flaskLocation_id", new_ref.
                                                         "artificial:shippingGuide", new_ref."catalogNumber", new_ref.
                                                         "otherCatalogNumbers", "preparations_id".id AS
                                                         "preparations_id", new_ref."individualCount", "sex_id".id AS
                                                         "sex_id", "lifeStage_id".id AS "lifeStage_id",
                                                         "reproductiveCondition_id".id AS "reproductiveCondition_id",
                                                         "establishmentMeans_id".id AS "establishmentMeans_id",
                                                         "behavior_id".id AS "behavior_id", new_ref."occurrenceRemarks",
                                                         "disposition_id".id AS "disposition_id", new_ref.
                                                         "associatedReferences", new_ref."associatedMedia", new_ref.
                                                         "previousIdentifications", new_ref."associatedOccurrences",
                                                         new_ref."fieldNumber", new_ref."day", new_ref."month", new_ref.
                                                         "year", new_ref."eventTime", new_ref."eventDate", new_ref.
                                                         "verbatimEventDate", new_ref."samplingProtocol", "habitat_id".
                                                         id AS "habitat_id", new_ref."eventRemarks", new_ref.
                                                         "fieldNotes", new_ref."measurementRemarks", "specie_id".id AS
                                                         "specie_id", "locality_id".id AS "locality_id", "waterBody_id".
                                                         id AS "waterBody_id", new_ref."minimumDepthInMeters", new_ref.
                                                         "maximumDepthInMeters", new_ref."locationRemarks",
                                                         "identificationQualifier_id".id AS
                                                         "identificationQualifier_id", new_ref."relationshipOfResource"
                                                         FROM "artificial:section_id", "basisOfRecord_id",
                                                         "institutionCode_id", "collectionCode_id", "datasetName_id",
                                                         "artificial:shelfLocation_id", "artificial:flaskLocation_id",
                                                         "preparations_id", "sex_id", "lifeStage_id",
                                                         "reproductiveCondition_id", "establishmentMeans_id",
                                                         "behavior_id", "disposition_id", "habitat_id", "specie_id",
                                                         "locality_id", "waterBody_id", "identificationQualifier_id"
                                                         WHERE "artificial:section_id".id IS NOT NULL AND new_ref.
                                                         "dcterms:modified" IS NOT NULL)
    ),"insert_recordedBy_biological_occurrence" AS (
INSERT
INTO "recordedBy_biological_occurrence" ("recordedBy_id", "biological_occurrence_id", "recordNumber") (SELECT id AS
                                                                                                       "recordedBy_id",
                                                                                                       new_ref.
                                                                                                       "occurrenceID",
                                                                                                       new_ref.
...
INSERT
INTO "identifiedBy_biological_occurrence" (value, "biological_occurrence_id") (SELECT id AS value, new_ref."occurrenceID" FROM "identifiedBy_id")
ON CONFLICT DO NOTHING;
END
$$
LANGUAGE plpgsql;
...
CREATE
OR REPLACE RULE "_INSERT" AS
    ON INSERT TO biological_occurrence_view
    DO INSTEAD
SELECT func_setof_biological_occurrence(NEW.*);