CREATE OR REPLACE VIEW "biological_occurrence_view" AS SELECT
  ...
  LEFT JOIN "specie" ON "specie".id = bo."specie_id"
	...
	LEFT JOIN "family" ON "family".id = "specie"."family_id"
	LEFT JOIN "order" ON "order".id = "specie"."order_id"
	LEFT JOIN "class" ON "class".id = "specie"."class_id"
	LEFT JOIN "phylum" ON "phylum".id = "specie"."phylum_id"
	LEFT JOIN "kingdom" ON "kingdom".id = "specie"."kingdom_id"
...
INSERT INTO "specie" ("typeStatus", "scientificName", "scientificNameAuthorship", "acceptedNameUsage", "kingdom_id", "phylum_id", "class_id", "order_id", "family_id", "genus_id", "subgenus_id", "artificial:subfamily_id", "artificial:subtribe_id", "artificial:tribe_id", "artificial:superfamily_id", "artificial:infraorder_id", "artificial:suborder_id", "artificial:superorder_id", "artificial:subclass_id", "artificial:subphylum_id", "specificEpithet", "infraspecificEpithet", "taxonRank", "taxonomicStatus_id", "originalNameUsage", "vernacularName", "nomenclaturalCode_id", "nameAccordingTo_id") (SELECT new_ref."typeStatus", new_ref."scientificName", new_ref."scientificNameAuthorship", new_ref."acceptedNameUsage", "kingdom_id".id AS "kingdom_id", "phylum_id".id AS "phylum_id", "class_id".id AS "class_id", "order_id".id AS "order_id", "family_id".id AS "family_id", "genus_id".id AS "genus_id", "subgenus_id".id AS "subgenus_id", "artificial:subfamily_id".id AS "artificial:subfamily_id" , "artificial:subtribe_id".id AS "artificial:subtribe_id", "artificial:tribe_id".id AS "artificial:tribe_id", "artificial:superfamily_id".id AS "artificial:superfamily_id", "artificial:infraorder_id".id AS "artificial:infraorder_id", "artificial:suborder_id".id AS "artificial:suborder_id", "artificial:superorder_id".id AS "artificial:superorder_id", "artificial:subclass_id".id AS "artificial:subclass_id", "artificial:subphylum_id".id AS "artificial:subphylum_id", new_ref."specificEpithet", new_ref."infraspecificEpithet", new_ref."taxonRank", "taxonomicStatus_id".id AS "taxonomicStatus_id", new_ref."originalNameUsage", new_ref."vernacularName", "nomenclaturalCode_id".id AS "nomenclaturalCode_id", "nameAccordingTo_id".id AS "nameAccordingTo_id" FROM "kingdom_id", "phylum_id", "class_id", "order_id", "family_id", "genus_id", "subgenus_id", "artificial:subfamily_id", "artificial:subtribe_id", "artificial:tribe_id", "artificial:superfamily_id", "artificial:infraorder_id", "artificial:suborder_id", "artificial:superorder_id", "artificial:subclass_id", "artificial:subphylum_id", "taxonomicStatus_id", "nomenclaturalCode_id", "nameAccordingTo_id") ON CONFLICT DO NOTHING RETURNING id
    ), "specie_id" AS (
SELECT COALESCE((SELECT id FROM "inserted_specie_id"), (SELECT id FROM "specie" WHERE "scientificName" = new_ref."scientificName")) AS id
